...
if __name__ == "__main__":
    ...
    #for i in read_data("data/2018-09-19-03_57_11_VN100.csv")[:10]:

        #compression_value = to_bytes(compression(i))
        #temp = aes.encrypt(binascii.hexlify(compression_value))
        #lines_compressed.append(temp)
